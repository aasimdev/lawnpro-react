...
const Dashboard: React.FC = () => {
  ...
  const breadcrumbs = [
    ...
    <Link underline="hover" key="2" color="black" href="/dashboard">
      Dashboard
    </Link>,
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-4">
        ...
        <div className="col-span-1 lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            {/* Monthly Plan */}
            <div
              className="rounded-xl border-[1px] border-solid border-main-gray bg-white flex flex-col px-4 py-[10px] relative"
              style={{
              ...
              <div className="flex items-center justify-start gap-[10px]">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[12px] font-medium text-[#525866]">
                    Projected revenue in the next <b>180</b> days{' '}
                  </span>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  <Tabs
                    value={messageTab}
                    onChange={(event: React.SyntheticEvent, newValue: number) => setMessageTab(newValue)}
                  ...
                  <Button>Show {!messageTab ? 'Emails' : 'Text Messages'}</Button>
                </div>
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <Button variant="outlined">Show All Events</Button>
            </div>
            <Divider />
            {/* Body */}
            <div className="flex flex-col gap-3">
        ...
        <div className="col-span-1 flex flex-col gap-6 w-full">
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <span className="text-xs font-normal text-[#99A0AE]">
                <b>8</b> New in past <b>185</b> days
              </span>
            </div>
            <Divider></Divider>
            {/* Body */}
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    ...
                    >
                      <Button>
                        <IconNavigateLeft size={12} />
                      </Button>
                      <Button>
                        <IconNavigateRight size={12} />
                      </Button>
                    </ButtonGroup>
                  </div>
                </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="text-[#99A0AE]">
                ...
                <span className="text-xs">
                  Your last <b>180</b> days payments
                </span>
              </div>
            </div>
          </DashboardItem>
            ...
            <div className="flex flex-col gap-[20px]">
              <div>
                <div className="flex items-center justify-between py-2">
                  ...
                  <div className="flex items-center gap-4">
                    <span className="text-sm font-medium">{formatToCurrency(823587.5)}</span>
                    <IconNavigateRight size={12} color="#525866" />
                  </div>
                </div>
                <div className="flex items-center justify-between py-2">
                  ...
                  <div className="flex items-center gap-4">
                    <span className="text-sm font-medium">{formatToCurrency(7658.0)}</span>
                    <IconNavigateRight size={12} color="#525866" />
                  </div>
                </div>
                <div className="flex items-center justify-between py-2">
              ...
              <div className="text-[#99A0AE] text-xs flex items-center gap-1">
                <InfoRounded width={14} />
                <span>
                  In the last <b>180</b> days you've sent <b>100</b> estimates
                </span>
              </div>
            </div>
          </DashboardItem>
