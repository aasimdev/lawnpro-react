...
import { IconAdd, IconCalendar, IconCall, IconDownload, IconHome, IconLocation, IconRanking, IconSafeDelivery, IconUser, IconUserSearch } from "../../utils/SvgUtil";
...
const Customers: React.FC = () => {
    ...
    const columns: Column<CustomerData>[] = [
        ...
        },
        {
            ...
            render: (row: CustomerData) => (
                row['status'] ? <div className="text-success-base bg-success-light rounded-full px-2 py-0.5 text-xs">• Active</div> : <div className="text-error-base bg-error-light rounded-full px-2 text-xs py-0.5" >• In-Active</div >
            )
        },
        {
    ...
    return (
        <div className="px-8 pt-4 flex flex-col gap-6">
            ...
            <DataTable data={customers} columns={columns} totalPages={5} actionMenu={actionDropdown} onSelectionChange={handleSelectionChange} />
        </div>
    )
}
