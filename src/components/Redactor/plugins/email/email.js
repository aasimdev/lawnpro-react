...
Redactor.add('plugin', 'email', {
    ...
    popupStyle(e, button) {
        ...
        this.app.dropdown.create('email', { html: form.getElement() });
        this.app.dropdown.open(e, button);
    },
    popupLine(e, button) {
        let instance = this.app.block.get();
        ...
        this.app.dropdown.create('line-setting', { html: form.getElement() });
        this.app.dropdown.open(e, button);
    },
    popupImageAlign(e, button) {
        ...
        this.app.dropdown.create('imagealign', { items: buttons });
        this.app.dropdown.open(e, button);
    },
    ...
    _buildBody(replace) {
        ...
        let utils = this.app.create('utils');
        let obj = (replace) ? {} : utils.cssToObject(this.$cont.attr('style'));
