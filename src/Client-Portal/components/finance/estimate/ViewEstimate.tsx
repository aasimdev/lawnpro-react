    ...
    <div className="px-8 pb-6 pt-20 bg-gray-week">
      <div className="p-4 rounded-2xl border border-faded-light shadow-sm bg-white">
        ...
        <div className="my-3 py-2 px-2.5 bg-information-light rounded-lg flex gap-2">
          ...
          <span className="text-sm text-text-dark">
            Make a Deposit by adding credit to your account
          </span>
          <span className="text-sm text-primary-base underline cursor-pointer">
            Add Credit
          </span>
        </div>
                      ...
                      <Grid item xs={6}>
                        <Box pr={1}>
                          <span className="text-gray-600 text-sm font-normal block ">
                            <span className="text-text-dark">Notes:</span> To
                            pay online or access our customer portal please
                          ...
                          <ul className="text-gray-600 text-sm font-normal list-decimal pl-5">
                            <li>
                              Click on “Client Login” Button on top of our
                              homepage.
                            </li>
                            <li>
                              Select Register and enter the email address
                              provided to us and then create a password.
                            </li>
                          </ul>
                        </Box>
                      </Grid>
                      <Grid item xs={2}>
                        <span className="text-text-dark block py-1 pl-16">
                          Subtotal
                        </span>
                        <span className="text-text-dark block py-1 bg-gray-week pl-16 rounded-l-lg">
                          Taxes
                        </span>
                        <span className="text-text-dark block  py-1 pl-16">
                          This Estimate
      ...
      <Box mt={4}>
        ...
        <div className="p-4 mt-4 bg-white border border-faded-light shadow-sm rounded-2xl space-y-1.5">
          ...
          >
            <span className="text-sm font-normal text-gray-600">
              Sent to Email: patrickcash1@me.com
            </span>
          </Box>
        </div>
      </Box>
